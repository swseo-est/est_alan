...
<div align="center">
  <img src="statictudio_ui.png" alt="Graph view in LangGraph studio UI" width="75%" />
</div>
...
2. **Extend the graph**: The core logic of the application is defined in [graph.py](srcgent/graph.py). You can modify this file to add new nodes, edges, or change the flow of information.
